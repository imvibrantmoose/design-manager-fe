...
const TemplateList = ({
  ...
  const canModifyTemplate = (templateCreatedBy: string) => {
    return userRole === "admin" || (userRole === "read-write" && templateCreatedBy === userId);
  };
  ...
  return (
    <div className="container mx-auto py-8 bg-background">
      <div className="flex flex-col space-y-6">
        {/* Simplified header with only title and count */}
        ...
        {/* Keep the search and filter section */}
                ...
                <Card key={template.id} className="flex flex-col h-full">
                  ...
                  <CardFooter className="flex items-center justify-between border-t pt-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {canModifyTemplate(template.createdBy) && (
                        <>
                          <Button
                            variant="outline"
                            size="sm"
